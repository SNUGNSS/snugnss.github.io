(() => {
  ...
  // ns-hugo-imp:D:\SNU-Temp\연구실_홈페이지_제작_251107\snugnss.githug.io-main_v2\_vendor\github.com\HugoBlox\hugo-blox-builder\modules\blox-tailwind\blox\shared\js\components\Icon.jsx
  ...
  // ns-hugo-imp:D:\SNU-Temp\연구실_홈페이지_제작_251107\snugnss.githug.io-main_v2\_vendor\github.com\HugoBlox\hugo-blox-builder\modules\blox-tailwind\blox\hero\component.jsx
  ...
  var HeroBlock = ({ content, design, id, icon_svg }) => {
    ...
    return /* @__PURE__ */ u2("div", { class: "relative isolate px-6 pt-14 lg:px-8", id, children: /* @__PURE__ */ u2("div", { class: `mx-auto max-w-2xl ${paddingClasses}`, children: [
      ...
      /* @__PURE__ */ u2("div", { class: "text-center", children: [
        ...
        content.text && /* @__PURE__ */ u2("p", { class: "mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300 max-w-2xl mx-auto", dangerouslySetInnerHTML: { __html: renderText(content.text) } }),
